...
public class BoardManager : MonoBehaviour
{
    ...
    {
        Debug.Log("Swapping tile positions: " + a.name + " with " + b.name);
        IsSwapping = true;
        ...
        Debug.Log($"Tiles swapped in array: {a.name} now at {indexB}, {b.name} now at {indexA}");
        ...
        Debug.Log("Tiles movement completed: " + a.name + " and " + b.name);
